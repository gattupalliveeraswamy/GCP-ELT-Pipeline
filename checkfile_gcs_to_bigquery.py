# sensor to check the file and upload to bigquery
...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket="veera_global_data",  # Replace with your bucket name
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table="my-bigquery-478902.staging_dataset.global_data",  # Replace with your project, dataset, and table name
        source_format="CSV",
